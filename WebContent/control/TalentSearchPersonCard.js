 ...
 */
            ...
            render : function(oRm, oControl) {
                ...
                for(var i = 0; i<vItemCount; i++) {
                	if(oControl.getChkBox()) {
                        ...
                        if(i==0){
                        	oRm.write("<td style='text-align:right;text-overflow: ellipsis;white-space: nowrap;overflow: hidden;color:#0093D0; font-weight:bold;'>");
    ...
    control.TalentSearchPersonCard.prototype.onclick = function(oBrowserEvent) {    
    	...
    	if(oClickedControlId == "IMG") this.firePress({pernr : this.getPernr(), ename : this.getName(), wave : this.getWave(), pernr2 : this.getPernr2()});
