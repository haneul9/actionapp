    ...
    jQuery.sap.includeStyleSheet("/sap/bc/ui5_ui5/sap/z_hr_ui5/css/L2PWindow.css");
        ...
        renderer : {
            ...
            render : function(oRm, oControl) {
            	...
            	if(oControl.getShowCollapseIcon()) {
                	...
                	oRm.writeClasses();
                	oRm.write(">");
                	oRm.write("<img id='" + oControl.getId() + "_Inner_SideWindowCollapsedImage' src='/sap/bc/ui5_ui5/sap/ZL2P01UI59000/images/icon_l.png'>");
