	...
	createContent : function(oController) {	
		...
		var oFilterBar = new sap.m.Toolbar({
			content : [ new sap.m.ToolbarSpacer({width: "10px"}),
						...
						new sap.m.Label({text : "코스트센터"}).addStyleClass("L2P13Font"),
		...
		var oTable = new sap.m.Table(oController.PAGEID + "_COMMON_SEARCH_KOSTL_TABLE", {
			...
			columns : [
			          new sap.m.Column({
			        	  header: new sap.m.Label({text : "코스트센터 코드"}).addStyleClass("L2P13Font"),
			        	  demandPopin: true,
			        	  hAlign : sap.ui.core.TextAlign.Begin,
			        	  minScreenWidth: "tablet"}),
			          new sap.m.Column({
		        		  header: new sap.m.Label({text : "코스트센터 이름"}).addStyleClass("L2P13Font"), 			        	  
			        	  demandPopin: true,
			        	  hAlign : sap.ui.core.TextAlign.Begin,
				          minScreenWidth: "tablet"}),
		        	  new sap.m.Column({
			        	  header: new sap.m.Label({text : "코스트센터 설명"}).addStyleClass("L2P13Font"), 			        	  
			        	  demandPopin: true,
			        	  hAlign : sap.ui.core.TextAlign.Begin,
			        	  minScreenWidth: "tablet"}),  	  
			          ]
