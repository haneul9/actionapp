...
//		);
		...
		oRow = new sap.ui.commons.layout.MatrixLayoutRow({});
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			content : new sap.m.Text({text : { path : "Datl4" ,
					formatter : function(fVal){
						return fVal ;
					}
				}
...
//		oRow.addCell(oCell);
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			content : new sap.m.Text({text : { path : "Datt5" ,
					formatter : function(fVal){
						return "직책임용일 : " + fVal ;
					}
				}
...
//		oRow.addCell(oCell);
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			content : new sap.m.Text({text : { path : "Datl5" ,
					formatter : function(fVal){
						return fVal ;
					}
				}
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			content : new sap.m.Text({text : { path : "Line6" ,
					formatter : function(fVal){
						return "학교/학위 : " + fVal ;
					}
				}
		...
		oRow.addCell(oCell);
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			content : new sap.m.Text({text : { path : "Datt6" ,
					formatter : function(fVal){
						return "P.G  승급일 : " + fVal ;
					}
				}
