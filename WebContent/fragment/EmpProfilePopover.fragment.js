sap.ui.jsfragment("fragment.EmpProfilePopover", {
	...
	createContent : function(oController) {
		...
		oCell0 = new sap.ui.commons.layout.MatrixLayoutCell({
			...
			colSpan : 2,
			content : [new sap.m.Text({text: "연락처 세부사항"}).addStyleClass("L2PQViewSubTitle")]
		}).addStyleClass("L2PQViewCell L2PPaddingLeft10");
		oRow.addCell(oCell0);
		...
		oCell0 = new sap.ui.commons.layout.MatrixLayoutCell({
			...
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			colSpan : 2,
			content : [new sap.m.Text({text: "휴대폰"}).addStyleClass("L2PQViewLabel")]
		}).addStyleClass("L2PQViewCell L2PPaddingLeft10");
		oProfileMatrix.createRow(oCell0);
		...
		oCell0 = new sap.ui.commons.layout.MatrixLayoutCell({
			...
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			colSpan : 2,
			content : [new sap.m.Text({text: "전화번호"}).addStyleClass("L2PQViewLabel")]
		}).addStyleClass("L2PQViewCell L2PPaddingLeft10");
		oProfileMatrix.createRow(oCell0);
		...
		oCell0 = new sap.ui.commons.layout.MatrixLayoutCell({
			...
			vAlign : sap.ui.commons.layout.VAlign.Bottom,
			colSpan : 2,
			content : [new sap.m.Text({text: "회사"}).addStyleClass("L2PQViewSubTitle")]
		}).addStyleClass("L2PQViewCell L2PPaddingLeft10");
		oRow.addCell(oCell0);
		oProfileMatrix.addRow(oRow);
		...
		oCell0 = new sap.ui.commons.layout.MatrixLayoutCell({
			...
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			colSpan : 2,
			content : [new sap.m.Text({text: "회사명"}).addStyleClass("L2PQViewLabel")]
		}).addStyleClass("L2PQViewCell L2PPaddingLeft10");
		oProfileMatrix.createRow(oCell0);
		...
		oCell0 = new sap.ui.commons.layout.MatrixLayoutCell({
			...
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			colSpan : 2,
			content : [new sap.m.Text({text: "주소"}).addStyleClass("L2PQViewLabel")]
		}).addStyleClass("L2PQViewCell L2PPaddingLeft10");
		oProfileMatrix.createRow(oCell0);
