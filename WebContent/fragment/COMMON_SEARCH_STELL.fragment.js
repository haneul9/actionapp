...
//			label : new sap.ui.commons.TextView({text : "Main Job Family", textAlign : "Center", width : "100%"}).addStyleClass("L2PFontFamily"), 
...
//			label : new sap.ui.commons.TextView({text : "Sub Job Family", textAlign : "Center", width : "100%"}).addStyleClass("L2PFontFamily"), 
