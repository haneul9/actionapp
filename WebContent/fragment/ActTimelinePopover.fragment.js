	...
	createContent : function(oController) {
		...
		var tlItem = new sap.suite.ui.commons.TimelineItem(oController.PAGEID + "_AT_TimeItem", {
			...
			title : {path : "Reqst", formatter : function(fVal) {
				if(fVal == "10") return "발령품의서를 저장 하였습니다.";
				else if(fVal == "20") return "발령품의서를 결재 상신 하였습니다.";
				else if(fVal == "30") return "발령품의서를 승인 하였습니다.";
				else if(fVal == "40") return "발령품의서를 반려 하였습니다.";
				else if(fVal == "50") return "발령품의서를 확정 하였습니다.";
				else if(fVal == "51") return "발령품의서를 게시 하였습니다.";
				else if(fVal == "52") return "발령품의서를 게시취소 하였습니다.";
			} },
