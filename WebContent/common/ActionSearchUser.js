...
common.ActionSearchUser = {
	...
	*/	
	...
	vColumns : [ {id : "Ename", label : "성명", control : "Text", width : "180", align : "left"}, //����
	             {id : "Pernr", label : "사번", control : "Text", width : "80", align : "left"}, //���
                 {id : "Fulln", label : "소속", control : "Text", width : "180", change : "OrgehC", align : "left"}, //�Ҽ�
                 ...
                 {id : "Zzrollvtx", label : "Role Level", control : "Text", width : "80", change : "ZzjobgrC", align : "left"}, //Role Level
                 {id : "Zzcaltltx", label : "직위", control : "Text", width : "80", change : "ZzcaltlC", align : "left"}, //����
                 {id : "Zzpsgrptx", label : "직책", control : "Text", width : "80", change : "ZzpsgrpC", align : "left"}, //��å
                 
                 {id : "Statx", label : "재직구분", control : "Text", width : "80", change : "PersgC", align : "left"}, //��������
                 {id : "Btrtx", label : "인사하위영역", control : "Text", width : "100", change : "BtrtlC", align : "left"}, //�λ� ���� ����
                 {id : "Gbdat", label : "생년월일", control : "Text", width : "80", align : "left"}, //�������
                 {id : "Geschtx", label : "성별", control : "Text", width : "60", align : "left"}, //����
                 {id : "Adid", label : "AD 계정", control : "Text", width : "80", align : "left"}, //AD ����
                 
                 {id : "Entda", label : "입사일", control : "Text", width : "80", align : "left"}, //�Ի���
