...
common.EmployeeProfile = {
	...
	*/	
	...
	makeListData : function(oController, Pernr, Menuid, MenuType, MenuMerge) {
		...
		if(typeof EmployeeProfileTable2 == "undefined") {
			createIBSheet2(document.getElementById(oController.PAGEID + "_DHtmlxTable"), "EmployeeProfileTable2", "100%",  (vTableHeight) + "px", IBSHeet_Locale);
		}
		
		EmployeeProfileTable2.Reset();
		
		EmployeeProfileTable2.SetTheme("TT", "TopTeam");
...
//		var c_w = Math.floor(100 / vTableHeader.length);
		...
		IBS_InitSheet(EmployeeProfileTable2, initdata);
		EmployeeProfileTable2.FitColWidth();
		EmployeeProfileTable2.SetSelectionMode(0);
		
		EmployeeProfileTable2.SetCellFont("FontSize", 0, "Value01", EmployeeProfileTable2.HeaderRows(), EmployeeProfileTable2.LastCol(), 12);
		EmployeeProfileTable2.SetCellFont("FontName", 0, "Value01", EmployeeProfileTable2.HeaderRows(), EmployeeProfileTable2.LastCol(), "Malgun Gothic");
		EmployeeProfileTable2.SetCellFont("FontBold", 0, "Value01", EmployeeProfileTable2.HeaderRows(), EmployeeProfileTable2.LastCol(), 1);
		EmployeeProfileTable2.SetHeaderRowHeight(32);
		EmployeeProfileTable2.SetDataRowHeight(32);
		
		EmployeeProfileTable2.SetHeaderBackColor("rgb(255,255,255)");
		EmployeeProfileTable2.SetFocusAfterProcess(0);
		
		
		if(MenuType == "7") {
			EmployeeProfileTable2.SetMergeSheet(1);
		} else {
			EmployeeProfileTable2.SetMergeSheet(0);
		}
		...
		EmployeeProfileTable2.LoadSearchData(vPersonListData);
	},
...
function EmployeeProfileTable2_OnSearchEnd(result) {
	if(common.EmployeeProfile.vTableType != "8") {
		for(var i=0; i<common.EmployeeProfile.vTableHeader.length; i++) {
			if(common.EmployeeProfile.vTableHeader[i].Width != "" && parseInt(common.EmployeeProfile.vTableHeader[i].Width) > 0) {
				EmployeeProfileTable2.SetColWidth(i, parseInt(common.EmployeeProfile.vTableHeader[i].Width));
			}
		}
		
		EmployeeProfileTable2.FitColWidth();
	} else {
		EmployeeProfileTable2.FitSize(1, 1);
...
//	EmployeeProfileTable2.SetExtendLastCol(true);
	
	EmployeeProfileTable2.SetCellFont("FontSize", EmployeeProfileTable2.HeaderRows(), "Value01", EmployeeProfileTable2.RowCount() + EmployeeProfileTable2.HeaderRows(), EmployeeProfileTable2.LastCol(), 12);
	EmployeeProfileTable2.SetCellFont("FontName", EmployeeProfileTable2.HeaderRows(), "Value01", EmployeeProfileTable2.RowCount() + EmployeeProfileTable2.HeaderRows(), EmployeeProfileTable2.LastCol(), "Malgun Gothic");
	
//	for(var i=0; i<EmployeeProfileTable2.RowCount(); i++) {
//		for(var j=0; j<=EmployeeProfileTable2.LastCol(); j++) {
//			EmployeeProfileTable2.SetCellBackColor(i + EmployeeProfileTable2.HeaderRows(), j, "rgb(255,255,255)");
//		}
//	}
}

function EmployeeProfileTable2_OnResize(Width, Height) {
